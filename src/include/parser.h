...
#define TESTING 0           //set TESTING to 1 and NORMAL 0 when testing AND MAKE CLEAN AFTER
#define NORMAL 1            //set TESTING to 0 and NORMAL to 1 when prekladacing AND MAKE CLEAN AFTER
